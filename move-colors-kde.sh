...
inactiveForeground=$color7" > ~/.kde/share/apps/color-schemes/$1.colors
...
echo "Made a plasma color scheme at ~/.kde/share/apps/color-schemes/$1.colors"
#echo "Don't forget to add it! System Settings -> Appearance -> Colors -> Install from File"

# Move new color scheme file into .local/share/color-shcemes folder
cp ~/.kde/share/apps/color-schemes/$1.colors ~/.local/share/color-schemes/
echo "New color scheme instatlled."
